...
enum LEAVE_PATH_CODE {
    ...
    LEAVE_CODE_SIG = 1<<1,
    /** 2: The recording application automatically leaves the channel and 
    ...
    /** 4: The recording application calls the 
 ...
 * For details, see [Video Statistics of the Remote Users](https://docs.agora.io/en/Interactive%20Broadcast/in_call_statistics_windows?platform=Windows#video-statistics-of-the-remote-users). 
 */
 ...
 * For details, see [Audio Statistics of the Remote Users](https://docs.agora.io/en/Interactive%20Broadcast/in_call_statistics_windows?platform=Windows#audio-statistics-of-the-remote-users).
 */
...
{
    /** The length of time (s) when the recording application is in the channel, 
     ...
     * 
     * - Communication profile: userCount = The number of users in the channel (including the recording application).
...
struct LiteraWatermarkConfig {
   ...
   * - Supports line breaks and word wrap.
   */
